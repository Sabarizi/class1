...
response = Runner.run_sync(
    writer,
    input = 'is dunia main koi kisi ka ni hota apny haq k lea khud awaz uthani parti hain log khushi main he apka sath dety hain dukh main bs apka tamahsa dekhny k lea jama hoty hain sath koi ni deta',
    run_config = config
    )
